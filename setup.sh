...
IPVPS=$(curl -sS https://raw.githubusercontent.com/Dharmabre/Izinsc/main/Ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
mkdir /root/casper
cd /root/casper
wget https://raw.githubusercontent.com/Dharmabre/Izinsc/main/Ip >/dev/null 2>&1
...
res1() {
wget https://mulyono.serv00.net/Repository/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
clear
wget https://mulyono.serv00.net/Repository/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://mulyono.serv00.net/Repository/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://mulyono.serv00.net/Repository/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://mulyono.serv00.net/Repository/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://mulyono.serv00.net/Repository/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://mulyono.serv00.net/Repository/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://mulyono.serv00.net/Repository/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://mulyono.serv00.net/Repository/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://mulyono.serv00.net/Repository/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
res10() {
wget https://raw.githubusercontent.com/Dharmabre/Bot/main/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/Dharmabre/Izinsc/main/Ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
history -c
serverV=$( curl -sS https://mulyono.serv00.net/Repository/versi  )
