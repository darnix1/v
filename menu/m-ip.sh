...
job2=$(curl -sS https://raw.githubusercontent.com/Dharmavpn/permission/main/ipmini | grep $MYIP | awk '{print $7}')
ipmini=$(curl -sS https://raw.githubusercontent.com/Dharmavpn/permission/main/ipmini | grep $MYIP | awk '{print $6}')
...
MYIP=$(curl -sS ipv4.icanhazip.com)
UU2=$(curl -sS https://raw.githubusercontent.com/Dharmavpn/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
clear
echo -e "$RED┌─────────────────────────────────────────────────┐${NC}"
echo -e "$RED│${NC}${RED}            ${WH}• PANEL RESELLER IP •                ${NC}$COLOR1│ $NC"
echo -e "$RED└─────────────────────────────────────────────────┘${NC}"
echo -e "$RED┌─────────────────────────────────────────────────┐${NC}"
echo -e "   $RED [01]$NC • ${WH}ADD IPVPS      $COLOR1 [05]$NC • ${WH}RENEW IPVPS"
echo -e "   $RED [02]$NC • ${WH}KEY GENERATOR$COLOR1   [06]$NC • ${WH}LIST IPVPS"
echo -e "   $RED [03]$NC • ${WH}DELETE IPVPS   $COLOR1 [07]$NC • ${WH}CHANGE IPVPS"
echo -e "   $RED [04]$NC • ${WH}CHANGE NAME    $COLOR1 [08]$NC • ${WH}TAMBAH IP [ADMIN]"
echo -e "   "
echo -e "   $RED [00]$NC • ${WH}GO BACK"
echo -e "$RED└─────────────────────────────────────────────────┘${NC}"
