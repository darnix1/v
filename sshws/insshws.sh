...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Dharmavpn/v/main/sshws/ws-dropbear
...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/Dharmavpn/v/main/sshws/ws-ovpn.py
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Dharmavpn/v/main/sshws/ws-stunnel
